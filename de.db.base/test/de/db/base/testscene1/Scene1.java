...
public class Scene1 {
	...
	protected void build() {
		...
		cartesian(2, Sets.newHashSet(andrew, lunaTiger), Sets.newHashSet(pascal, emily));
		cartesian(2, Sets.newHashSet(andrew, lunaTiger), Sets.newHashSet(matthieu, svenja));
		cartesian(2, Sets.newHashSet(matthieu, svenja), Sets.newHashSet(pascal, emily));
	}
