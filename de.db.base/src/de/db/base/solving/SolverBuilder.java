...
//
// public ISolver create(IPersonProvider personProvider, IPersonWeigthDeterminer
// personWeigthDeterminer,
// IRoomDescriptor roomDescriptor) {
// performPreChecks(personProvider, personWeigthDeterminer, roomDescriptor);
// return new ShuffleSolver(personProvider, personWeigthDeterminer,
// roomDescriptor, 10000);
// }
//
// private void performPreChecks(IPersonProvider personProvider,
// IPersonWeigthDeterminer personWeigthDeterminer,
// IRoomDescriptor roomDescriptor) {
